...
class Object:
    ...
    def draw(self):
        ...
        if libtcod.map_is_in_fov(fov_map, self.x, self.y):
            ...
            if x is not None:
                ...
                libtcod.console_put_char(con, int(x), int(y), self.char,
                                         libtcod.BKGND_NONE)
    ...
    def clear(self):
        ...
        if x is not None:
            libtcod.console_put_char(con, int(x), int(y), ' ',
                                     libtcod.BKGND_NONE)
...
def save_game():
    ...
    file['player_index'] = objects.index(
        player)  #index of player in objects list
...
def load_game():
    ...
    player = objects[file[
        'player_index']]  #get index of player in objects list and access it
...
def new_game():
    ...
    fighter_component = Fighter(hp=300,
                                defense=20,
                                power=5,
