...
def main() -> None:
    ...
    terminal.set(
        "0x2000: inventory-ui2.png, size=32x32, resize-filter=nearest, align=top-left"
    )
    terminal.set(
        "0x3000: wall_tiles4.png, size=32x32, resize-filter=nearest, align=top-left"
    )
    terminal.set(
        "0x4000: voidstone_background_1536x864.png, size=1536x864, resize=1792x1184,resize-filter=nearest, align=top-left"
    )
